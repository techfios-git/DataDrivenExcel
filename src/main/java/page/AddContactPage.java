...
WebDriver driver;
	...
	@FindBy(how = How.XPATH, using = "//span[contains(text(),'CRM')]") WebElement CRM_FIELD_LOCATOR;
	@FindBy(how = How.XPATH, using = "//a[contains(text(),'Add Contact')]") WebElement ADD_CONTACT_FIELD_LOCATOR;
	@FindBy(how = How.XPATH, using = "//input[@id='account']") WebElement Full_NAME_FIELD_LOCATOR;
	@FindBy(how = How.XPATH, using = "//input[@id='company']") WebElement COMPANY_FIELD_LOCATOR;
